...
func TestCreateAccountAPI(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			request, err := http.NewRequest(http.MethodPost, "/accounts", io.NopCloser(bytes.NewReader(data)))
			require.NoError(t, err)
...
func requireBodyMatchAccounts(t *testing.T, body *httptest.ResponseRecorder, accounts []db.Account) {
