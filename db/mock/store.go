...
// Source: github.com/dralos/simplebank/db/sqlc (interfaces: Store)
//
...
import (
	...
	sqlc "github.com/dralos/simplebank/db/sqlc"
...
func (m *MockStore) UpdateTransferAmount(ctx context.Context, arg sqlc.UpdateTransferAmountParams) (sqlc.Transfer, error) {
	m.ctrl.T.Helper()
